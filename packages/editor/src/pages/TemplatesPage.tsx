...
const TEMPLATES: TemplateDefinition[] = [
  {
    ...
    nodes: [
      { id: 'node_tpl_1', type: 'siberNode', position: { x: 50, y: 200 }, data: { nodeType: 'webhook', label: 'Webhook Trigger', parameters: { path: '/customer-support' } } },
      { id: 'node_tpl_2', type: 'siberNode', position: { x: 300, y: 200 }, data: { nodeType: 'openai', label: 'AI Analysis', parameters: { prompt: 'Analyze customer message and determine sentiment and urgency.' } } },
      { id: 'node_tpl_3', type: 'siberNode', position: { x: 550, y: 100 }, data: { nodeType: 'ifCondition', label: 'Urgency Check', parameters: { condition: 'urgency === "high"' } } },
      { id: 'node_tpl_4', type: 'siberNode', position: { x: 800, y: 50 }, data: { nodeType: 'slack', label: 'Slack Alert', parameters: { channel: '#support-urgent' } } },
      { id: 'node_tpl_5', type: 'siberNode', position: { x: 800, y: 250 }, data: { nodeType: 'email', label: 'Email Response', parameters: {} } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'node_tpl_1', type: 'siberNode', position: { x: 50, y: 200 }, data: { nodeType: 'cron', label: 'Daily Schedule', parameters: { expression: '0 8 * * *' } } },
      { id: 'node_tpl_2', type: 'siberNode', position: { x: 300, y: 200 }, data: { nodeType: 'httpRequest', label: 'Fetch RSS Feeds', parameters: { url: 'https://news.example.com/rss' } } },
      { id: 'node_tpl_3', type: 'siberNode', position: { x: 550, y: 200 }, data: { nodeType: 'openai', label: 'AI Summarize', parameters: { prompt: 'Summarize these news articles into a concise digest.' } } },
      { id: 'node_tpl_4', type: 'siberNode', position: { x: 800, y: 200 }, data: { nodeType: 'email', label: 'Send Digest', parameters: {} } },
    ],
    edges: [
      { id: 'edge_tpl_1', source: 'node_tpl_1', target: 'node_tpl_2' },
      { id: 'edge_tpl_2', source: 'node_tpl_2', target: 'node_tpl_3' },
  ...
  },
  {
    ...
    glowColor: 'group-hover:shadow-neon-green',
    nodes: [
      { id: 'node_tpl_1', type: 'siberNode', position: { x: 50, y: 200 }, data: { nodeType: 'webhook', label: 'GitHub Webhook', parameters: { path: '/github-issues' } } },
      { id: 'node_tpl_2', type: 'siberNode', position: { x: 300, y: 200 }, data: { nodeType: 'openai', label: 'AI Categorize', parameters: { prompt: 'Categorize this GitHub issue and draft a response.' } } },
      { id: 'node_tpl_3', type: 'siberNode', position: { x: 550, y: 100 }, data: { nodeType: 'httpRequest', label: 'Post Comment', parameters: { method: 'POST' } } },
      { id: 'node_tpl_4', type: 'siberNode', position: { x: 550, y: 300 }, data: { nodeType: 'httpRequest', label: 'Add Labels', parameters: { method: 'POST' } } },
      { id: 'node_tpl_5', type: 'siberNode', position: { x: 800, y: 100 }, data: { nodeType: 'slack', label: 'Notify Team', parameters: { channel: '#github' } } },
      { id: 'node_tpl_6', type: 'siberNode', position: { x: 800, y: 300 }, data: { nodeType: 'logger', label: 'Log Result', parameters: {} } },
    ],
    edges: [
      { id: 'edge_tpl_1', source: 'node_tpl_1', target: 'node_tpl_2' },
      { id: 'edge_tpl_2', source: 'node_tpl_2', target: 'node_tpl_3' },
  ...
  },
  {
    ...
    glowColor: 'group-hover:shadow-neon-violet',
    nodes: [
      { id: 'node_tpl_1', type: 'siberNode', position: { x: 50, y: 200 }, data: { nodeType: 'cron', label: 'Schedule Trigger', parameters: { expression: '0 10,14,18 * * *' } } },
      { id: 'node_tpl_2', type: 'siberNode', position: { x: 300, y: 200 }, data: { nodeType: 'httpRequest', label: 'Fetch Content', parameters: {} } },
      { id: 'node_tpl_3', type: 'siberNode', position: { x: 550, y: 200 }, data: { nodeType: 'openai', label: 'Generate Captions', parameters: { prompt: 'Generate engaging social media captions for this content.' } } },
      { id: 'node_tpl_4', type: 'siberNode', position: { x: 800, y: 100 }, data: { nodeType: 'httpRequest', label: 'Post to Twitter', parameters: {} } },
      { id: 'node_tpl_5', type: 'siberNode', position: { x: 800, y: 200 }, data: { nodeType: 'httpRequest', label: 'Post to LinkedIn', parameters: {} } },
      { id: 'node_tpl_6', type: 'siberNode', position: { x: 800, y: 300 }, data: { nodeType: 'httpRequest', label: 'Post to Instagram', parameters: {} } },
      { id: 'node_tpl_7', type: 'siberNode', position: { x: 1050, y: 200 }, data: { nodeType: 'logger', label: 'Log Results', parameters: {} } },
    ],
    edges: [
      { id: 'edge_tpl_1', source: 'node_tpl_1', target: 'node_tpl_2' },
      { id: 'edge_tpl_2', source: 'node_tpl_2', target: 'node_tpl_3' },
